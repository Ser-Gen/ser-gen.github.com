...
//   получить сохранённое место
//     да — место = сохранённое место
//     нет — место = место по умолчанию

//   если место по умолчанию
//     проба получить настоящее место
//       да — место = полученное место
//       нет — место по умолчанию


// получение данных

//   получить данные по найденному месту
...
(function( window, undefined ) {
  ...
  function problem_callback() {
    console.log('well.. we have tryed locate.');
    tryGetLocalPos();
    pos.alternate = true;
    placeProcessor(pos);
  }
