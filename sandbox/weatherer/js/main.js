...
// Яндекс.Браузер использует старое событие конца перехода
...
function smoothChanger() {
  ...
  weatherNow.addEventListener(transitionend, setData, false);
}

// устанавливает данные
function setData() {
  weatherNow.removeEventListener(transitionend, setData, false);
...
window.insertWeather = function (weather) {
...
window.insertForecastHours = function (forecastHours) {
...
window.insertForecastDaily = function (forecastDaily) {
