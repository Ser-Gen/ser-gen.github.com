...
Для того, чтобы вёрстка сайта была легко поддерживаемой, её необходимо изначально создавать по специальным правилам.
...
Чтобы получить универсальный элемент, способный использоваться снова и снова, не ломающий любые другие добавляемые в него элементы, нужно сверстать его немного по-другому.
...
**Блок** — совокупность разнородных элементов, связанных общим назначением, контейнер для **элементов** блока. Служит для изменения поведения блока на странице: используется для позиционирования, может изменяться модификаторами.
...
**Блоки** могут вкладываться друг на друга, накладываться друг на друга (получаются _миксы_, таким образом расширяется функциональность блока).
